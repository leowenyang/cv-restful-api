...
def autoDoc(app, config):
    """
    自动文档
    """
    swaggerConfig = Swagger.DEFAULT_CONFIG
    swaggerConfig['title'] = config.SWAGGER_TITLE
    swaggerConfig['description'] = config.SWAGGER_DESC
    swaggerConfig['host'] = config.BIND
